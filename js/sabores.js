(function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      var nuevoTexto = document.createTextNode("Menta, Vainilla");
      ...
      viejoNodo.parentNode.replaceChild(nuevoTitulo, viejoNodo);
        ...
        var nuevoTexto1 = document.createTextNode("Vainilla, Moscatel, Plátano");
        ...
        var nuevoTexto2 = document.createTextNode("Uva, Fresa, Melón, Durazno, Guanábana, Manzana, Naranja");
        ...
        var nuevoTexto3 = document.createTextNode("Moscatel, Platano, Vainilla");
